...
class Locale {
     ...
     * @param {string} locale The locale to use. The default is "en", for English.
    ...
    static text(locale, key, ...args) {
        ...
        if(!string) string = this.texts["en"][key]; // Fallback to english, will return undefined if the key is invalid
